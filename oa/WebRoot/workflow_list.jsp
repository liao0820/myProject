...
<head>
    ...
    <script type="text/javascript">
       function confirmDel(param)
       {
          ...
          document.location="delDeployment?deploymentId="+param
       }
        }  
    </script>
</head>
                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                            <!--href="delDeployment?deploymentId=${dep.id}" -->
	                            <a href="#" onclick="confirmDel('${dep.id}')" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
