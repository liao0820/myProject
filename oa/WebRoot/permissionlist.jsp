...
<head>
    ...
    <script src="bootstrap/js/bootstrap.min.js"></script>
       ...
       function confirmDel(param)
       {
          ...
          document.location="delRole?roleId="+param
       }
        }  
    </script>
</head>
				                	...
				                	<tr id="${role.id}">
				                		...
				                		<td>
				                			<a href="#" onclick="viewPermissions('${role.id}')" class="btn btn-info btn-xs" ><span class="glyphicon glyphicon-edit"></span> 编辑</a>
											  <a href="#" onclick="confirmDel('${role.id}')" class="btn btn-danger btn-xs" onclick="return checkValidate()"><span class="glyphicon glyphicon-remove"></span> 删除</a>
				                		</td>
				                	</tr>
				                </c:forEach>
	                    </tbody>
