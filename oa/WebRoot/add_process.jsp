...
<head>
    ...
    function checkValidate(){
   		var flag = true;
		 var names=document.getElementById("processName").value;
		 if(""==names){
			 window.alert("流程名称不能为空！！！"); 
			 flag=false;
			 return flag;
		 }
		 if (flag==true) {
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="return checkValidate()">部署流程</button>
                        </div>
                </div>
            </form>
        </div>
