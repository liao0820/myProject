...
<head>
    ...
    function checkValidate(){
   		var flag = true;
		 var names=document.getElementById("roleName").value;
		 if(""==names){
			 window.alert("不能为空！！！"); 
			 flag=false;
			 return flag;
...
<div class="page-content">
    	...
    	<div class="panel panel-default">
    		...
    		<div class="panel-body">
    			<div class="form-group">
                     ...
                     <button type="submit" class="btn btn-primary" onclick="return checkValidate()">保存角色和权限</button>
                </div>
    		</div>
    	</div>
        <div class="panel panel-default">
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
	  ...
	  <form id="permissionForm" name="form" action="saveSubmitPermission" method="post" onSubmit="return beforeSubmit(this);">
